...
public class Controller implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        carAge.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        carAge.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
        ...
        engineSize.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        engineSize.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if(!newValue){
                    engineSize.validate();
        ...
        numValidator = new NumberValidator();
        carValue.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        carValue.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if(!newValue){
                    carValue.validate();
        ...
        numValidator = new NumberValidator();
        goodsWeight.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        goodsWeight.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if(!newValue){
                    goodsWeight.validate();
                }
            }
        });
        numValidator = new NumberValidator();
        goodsCost.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        goodsCost.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if(!newValue){
                    goodsCost.validate();
        ...
        numValidator = new NumberValidator();
        moneyAmount.getValidators().add(numValidator);
        numValidator.setMessage("Разрешены только цифры");
        moneyAmount.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if(!newValue){
                    moneyAmount.validate();
                }
            }
        });
